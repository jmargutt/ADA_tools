...
python ~/caladrius-master/caladrius/run.py --run-name caladrius_2020 --data-path ~/datalake/maxar/typhoon-mangkhut-2/caladrius --model-path ~/datalake/caladrius-models/all_wind_class_10_epochs-input_size_32-learning_rate_0.001-batch_size_16/best_model_wts.pkl --checkpoint-path ~/datalake/maxar/typhoon-mangkhut-2/caladrius/runs --output-type classification --inference
